...
os.environ["POWERTOOLS_METRICS_NAMESPACE"] = "IntelligenceApi"
os.environ["POWERTOOLS_SERVICE_NAME"] = "IntelligenceApi"
...
app = FastAPI(title="IntelligenceApi", responses={500: {"model": InternalServerErrorDetails}})
