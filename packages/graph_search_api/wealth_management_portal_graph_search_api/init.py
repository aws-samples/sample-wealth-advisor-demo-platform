...
os.environ["POWERTOOLS_METRICS_NAMESPACE"] = "GraphSearchApi"
os.environ["POWERTOOLS_SERVICE_NAME"] = "GraphSearchApi"
...
app = FastAPI(title="GraphSearchApi", responses={500: {"model": InternalServerErrorDetails}})
